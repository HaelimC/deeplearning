...
class MyPytorchModel(pl.LightningModule):
    ...
    def prepare_data(self):
        ...
        #my_transform = transforms.Normalize(mean, std, inplace=False)

        
        my_transform = transforms.Compose([transforms.ToTensor(), transforms.Normalize(mean, std, inplace=False)])
