...
class RegressionNet(Network):
    ...
    def forward(self, X):
        ...
        layer1, cache_affine1 = affine_forward(X, W1, b1)
        layer2, cache_sigmoid = sigmoid_forward(layer1)
        y, cache_affine2 = affine_forward(layer2, W2, b2)
    ...
    def backward(self, dy):
        ...
        layer1, dW2, db2 = affine_backward(dy, cache_affine2)
        layer2 = sigmoid_backward(layer1, cache_sigmoid)
        y, dW1, db1 = affine_backward(layer2, cache_affine1)
